...
import { DollarSign, TrendingUp, TrendingDown, Plus, Receipt, Calculator, Trash2, CheckCircle2, BarChart3, Calendar, Building2, AlertCircle } from 'lucide-react';
        ...
        <TabsContent value="tax">
          <div className="max-w-lg space-y-4">
            ...
            <div className="bg-primary/10 border border-primary/20 rounded-xl p-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">25% of net profit</p>
                </div>
            ...
            <p className="text-[10px] text-muted-foreground px-1 leading-relaxed">
              * Estimate only. Does not account for self-employment tax, deductions, or state obligations. Consult your accountant for actual tax guidance.
            </p>
          </div>
        </TabsContent>
      </Tabs>
